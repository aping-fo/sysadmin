    ...
    <div class="main-content" >
        ...
        <section class="panel">
                ...
                <form method="post" id = "AfficheForm" class="form-horizontal bucket-form">
                    <div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">发布时间</label>
                            ...
                            <input type="hidden" placeholder="公告类型:广告公告" name="state" value="0" />
                        	</div>
					</div>
					<div class="form-group">
			...
			`		<div class="form-group text-center">
						<button class="btn btn-primary" type="submit">发布广告</button>
					</div>
                </form>
            </div>
        </section>
		...
		function submitResult(data) {
			...
			if (data.success == true) {
				layer.msg("发布成功", {
					...
					window.location.href = "${BASE_PATH}/gameManage";
				});
			} else {
