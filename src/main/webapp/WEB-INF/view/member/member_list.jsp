...
<body class="sticky-header">
	...
	<jsp:include page="../frame/menu.jsp"></jsp:include> <!-- left side end--> <!-- main content start-->
		...
		<div class="wrapper">
			<div class="row">
				<div class="col-sm-12">
					...
					会员信息 &nbsp;&nbsp;&nbsp; <a onclick="openSearch()" title="搜索" ><i class="fa fa-search"></i></a> 
							&nbsp;&nbsp;&nbsp; <a onclick="addSearch()" title="添加" ><i class="fa fa-plus"></i></a>
	...
	function memberLook(data, sumRechargeCount) {
		...
		function addSearch() {
			layer.prompt({
				...
				$.ajax({
					url : '${BASE_PATH}/member/boundMember',
					datatype : 'json',
					type : 'post',// ‘get’
					data : {
						memberID : value
		...
		// 会员冻结
// 		function memberEdit(id, sign) {
// 			layer.confirm('你确定' + sign + '此会员?', {
// 				btn : [ '确定', '在想想' ], //可以无限个按钮
// 				title : "提示",
// 			}, function(index, layero) {
// 				location.href = "member/freezeMember?memberID=" + id;
// 			}, function(index) {
// 				//按钮【按钮二】的回调
// 			});
// 		}
...
// 								sign = "恢复";
							...
							var str = "<tr><td>"
									...
									+ "</td></tr>";
									// "<a onclick='memberEdit("+data.GameID+","+sign+")' ><span class='label label-danger label-mini' style='margin-left:5px;'>"+sign+"</span></a>
